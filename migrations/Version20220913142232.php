 ...
 */
final class Version20220913142232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE modules_partenaire (modules_id INT NOT NULL, partenaire_id INT NOT NULL, INDEX IDX_C2A4CFA060D6DC42 (modules_id), INDEX IDX_C2A4CFA098DE13AC (partenaire_id), PRIMARY KEY(modules_id, partenaire_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
