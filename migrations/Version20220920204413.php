 ...
 */
final class Version20220920204413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partenaires_modules_modules (partenaires_modules_id INT NOT NULL, modules_id INT NOT NULL, INDEX IDX_3694160F9AD0B8B0 (partenaires_modules_id), INDEX IDX_3694160F60D6DC42 (modules_id), PRIMARY KEY(partenaires_modules_id, modules_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
