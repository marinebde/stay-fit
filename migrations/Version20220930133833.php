 ...
 */
final class Version20220930133833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE structure_module (structure_id INT NOT NULL, module_id INT NOT NULL, INDEX IDX_159DC1022534008B (structure_id), INDEX IDX_159DC102AFC2B591 (module_id), PRIMARY KEY(structure_id, module_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
